...
?>  <body>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-dropdown">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="#" class="menu-link, highlight">The Boardwalk</a></li>
        ...
        <main>
            <div class="LocationPages">
                <h1 id="Location_Name">The Boardwalk</h1>
                ...
                <script>
                    ...
                    const images = [
                        {
                            path: "../../../assets/images/Boardwalk/Boardwalk.png",
                            description: "Photo of The Boardwalk"
                        },
                        {
                            path: "../../../assets/images/Boardwalk/Boardwalk2.png",
                            description: "Photo of The Boardwalk"
                        }
                    ];
                ...
                <div class="Location_Des">
                    <p class="text"> 
                        Tourist attraction in Cape May County, New Jersey<br>
                        Buzzing beach strip with a vintage amusement park, mini-golf & stands for pizza, fudge & ice cream.<br>
                        Open 24 hours<br>
                    </p>
                </div>
                ...
                <div class="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15810.087798131337!2d-74.56864768582969!3d39.275270349716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c0eacc0b9481d7%3A0xd2aa8ce9dd917191!2sOcean%20City%20Boardwalk!5e0!3m2!1sen!2sus!4v1676583930528!5m2!1sen!2sus" width="800" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </main>
