...
?>  <body>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-dropdown">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="#" class="menu-link, highlight">CJ's</a></li>
        ...
        <main>
            <div class="LocationPages">
                <h1 id="Location_Name">The CJ's</h1>
                ...
                <script>
                    ...
                    const images = [
                        {
                            path: "../../../assets/images/CJ/Logo.png",
                            description: "Photo of CJ's Logo"
                        },
                        {
                            path: "../../../assets/images/CJ/front.png",
                            description: "Photo of the Front at CJ's"
                        }
                    ];
                ...
                <div class="Location_Des">
                    <p class="text"> 
                        ...
                        Phone: <a href="tel:6099274701">(609) 927-4701</a>
                    </p>
                </div>


                <div class="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3086.8239221388335!2d-74.59748658455486!3d39.3149145795085!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c0c02a47a1f99d%3A0xe4db48ceea8b9cb8!2sC%20J&#39;s%20Corner!5e0!3m2!1sen!2sus!4v1676583847329!5m2!1sen!2sus" width="800" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </main>
