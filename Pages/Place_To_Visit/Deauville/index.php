...
?>  <body>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-dropdown">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="#" class="menu-link, highlight">Deauville Inn</a></li>
        ...
        <main>
            <div class="LocationPages">
                <h1 id="Location_Name">The Deauville Inn</h1>
                ...
                <script>
                    ...
                    const images = [
                        {
                            path: "../../../assets/images/Deauville/Above.png",
                            description: "Photo of The Deauville Inn from Above"
                        },
                        {
                            path: "../../../assets/images/Deauville/BayView.png",
                            description: "Illustration of The Deauville Inn from the Bay"
                        },
                        {
                            path: "../../../assets/images/Deauville/Inside.png",
                            description: "Photo of the Inside of The Deauville Inn"
                        }
                ...
                <div class="Location_Des">
                    <p class="text"> 
                        Longtime waterfront restaurant & sports bar offering traditional American seafood & meat dishes.<br>
                        Service options: Dine-in · Curbside pickup · No delivery<br>
                        Phone: <a href="tel:6092632080">(609) 263-2080</a>
                    </p>
                </div>


                <div class="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3091.8743439965306!2d-74.65773938455814!3d39.20030387952512!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c0bc242b8477df%3A0x592dbab6e83b2d9b!2sThe%20Deauville%20Inn!5e0!3m2!1sen!2sus!4v1676583904520!5m2!1sen!2sus" width="800" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </main>
