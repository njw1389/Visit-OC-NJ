...
?>  <body>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-dropdown">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="#" class="menu-link, highlight">Charlie's</a></li>
        ...
        <main>
            <div class="LocationPages">
                <h1 id="Location_Name">Charlie's</h1>
                ...
                <script>
                    ...
                    const images = [
                        {
                            path: "../../../assets/images/Charlies/front.png",
                            description: "Photo of the front of Charlie's"
                        },
                        {
                            path: "../../../assets/images/Charlies/food.png",
                            description: "Photo of the food at Charlie's"
                        }
                    ];
                ...
                <div class="Location_Des">
                    <p class="text">
                        Bustling, cash-only restaurant offering standard pub eats, brews on tap & organized activities.<br>
                        Service options: Dine-in · Takeout · No delivery<br>
                        Phone: <a href="tel:6099273663">(609) 927-3663 </a>
                    </p>
                </div>


                <div class="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3086.9315451764564!2d-74.59833668455501!3d39.312475179508766!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c0c0299ffd99a1%3A0x6cb2adff08563c20!2sCharlie&#39;s!5e0!3m2!1sen!2sus!4v1676583802843!5m2!1sen!2sus" width="80" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </main>
